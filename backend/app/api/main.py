...
from app.api.routes import appointments, webhooks, health, auth, admin, bookings, customer_profile, diagnostics, mechanic_profile, mechanics, vehicles, ws
...
api_router.include_router(appointments.router, prefix="/appointments", tags=["scheduled service"])
